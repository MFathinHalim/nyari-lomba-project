    ...
    >
      ...
      <div>
        ...
        {competition.imageUrl && (
          <div className={`mb-4 border-2 ${competition.source.includes("Puspresnas") ? "rounded-full h-80 w-80" : "aspect-[3/4] w-full"} border-zinc-900 overflow-hidden bg-zinc-100 transition-shadow group-hover:border-white`}>
            <img 
